...
<div class='mb-1 grid columns-2 gap-1'>
    <div>
        ...
        <select v-model='node.data.source' class='form-control' @change='hydrate'>
    ...
    >
        ...
        <select class='form-control' @change='hydrate' v-model='node.data.size'>
...
<div v-if='node.data.source=="media"'>
    <wp-media v-model:selected='node.data.ID' @update:selected='hydrate'></wp-media>
</div>
