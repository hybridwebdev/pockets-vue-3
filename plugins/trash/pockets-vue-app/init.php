<?php
/**
	Plugin Name: Pockets Vue App
	Plugin URI: fweb.co.nz
	Description: A Vue App
	Author: Fweb
	Version: 1.0 (beta) 
*/
namespace pockets_vue_app;
class init {
    public $namespace = __NAMESPACE__;
	public $role = 'pockets-developer';
	...
	function meta_tag(){ 
		...
		*/
	?>
		<meta name="pockets-vue-app" content="<?= $this->vue_config['host'] ?>"/>
	<?php }
    function initConfig(){
	...
	function get_built_assets(){
		...
		return [
			...
			'chunk-vendors.js' => "$host{$manifest['chunk-vendors.js']}",
